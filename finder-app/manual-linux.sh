...
echo "Copying the finder related scripts and executables to $OUTDIR/rootfs/home"
sudo cp writer finder.sh finder-test.sh autorun-qemu.sh ${OUTDIR}/rootfs/home
